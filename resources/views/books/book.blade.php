...
<div class="container">
    <div class="row justify-content-center mb-5">
        <div class="col-md-8">
            ...
            <img src="{{ url('foto').'/'. $book->foto }}" class="card-img-top" style="max-width:500px; max-height:400px" alt="no pos" class="img-fluid">
        ...
        <form method="post" action="/borrows">
            ...
            <div class="modal-body">
                <div class="form-group">
                    ...
                    <input type="text" id="user_id" value="{{ $user_id }}" name="user_id" class="form-control" readonly required>
                </div>
                <div class="form-group">
                    <label for="book_id">book_id:</label>
                    <input type="text" id="book_id" value="{{ $book->id }}" name="book_id" class="form-control" readonly required>
                </div>
                <div class="form-group">
